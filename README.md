# Hi there, I'm ATARO-QQQ

<div align="center">
  <img src="https://komarev.com/ghpvc/?username=ataro-qqq&label=PROFILE+VIEWS&color=0e75b6&style=for-the-badge" alt="Profile Views" />
</div>
...
<details open>
<summary><b>日本語 (ja-JP)</b></summary>
<br>

どうも、ATARO-QQQ (A.N.の社畜) です！  
社会心理学が好きな不審者です。  
コーディングは主にHTML･js等のブラウザ言語と、RやPHP等での統計分野に取り組んでいます。  
...
<details>
<summary><b>English (en-GB)</b></summary>
<br>

Right then, I'm ATARO-QQQ (A.N.'s wage slave)!  
Just a curious fellow with a keen interest in social psychology.  
My coding focus is mainly on browser languages such as HTML and JavaScript, alongside statistical computing using R and PHP.  
...
<details>
<summary><b>Latina (lat)</b></summary>
<br>

Salvetis! Ego sum ATARO-QQQ (servus operarius A.N.)!  
Homo mentes hominum et psychologiam socialem studiosissime investigans sum.  
Codices scribendo, praecipue linguis interretialibus (ut HTML et JS) et rationibus statisticis (cum R et PHP) operam do.  
